...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-article/node_modules/article/lib/fase-2/hardcode.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header low">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-article/node_modules/article/lib/fase-2/hardcode.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-article/node_modules/article/lib/fase-2/</a> &#187; hardcode.js</div>
</div>
<div class="body">
...
//
&nbsp;
<span class="fstat-no" title="function not covered" >function Hardcode(top) {</span>
<span class="cstat-no" title="statement not covered" >  this.top = top;</span>
}
module.exports = Hardcode;
&nbsp;
Hardcode.prototype.reduce = <span class="fstat-no" title="function not covered" >function () {</span>
...
<span class="cstat-no" title="statement not covered" >      if (self._removeNode(node)) {</span>
...
Hardcode.prototype._removeNode = <span class="fstat-no" title="function not covered" >function (node) {</span>
<span class="cstat-no" title="statement not covered" >  if (node.attr.hasOwnProperty('class') &amp;&amp; NEGATIVE_KEYWORD.test(node.attr['class'])) {</span>
<span class="cstat-no" title="statement not covered" >    return true;</span>
  }
&nbsp;
<span class="cstat-no" title="statement not covered" >  if (node.attr.hasOwnProperty('id') &amp;&amp; NEGATIVE_KEYWORD.test(node.attr.id)) {</span>
<span class="cstat-no" title="statement not covered" >    return true;</span>
  }
&nbsp;
<span class="cstat-no" title="statement not covered" >  if (node.attr.hasOwnProperty('class') &amp;&amp; NEGATIVE_CLASSNAME.test(node.attr['class'])) {</span>
<span class="cstat-no" title="statement not covered" >    return true;</span>
  }
&nbsp;
<span class="cstat-no" title="statement not covered" >  if (domHelpers.NO_TEXT_ELEMENTS.hasOwnProperty(node.tagname)) {</span>
<span class="cstat-no" title="statement not covered" >    return true;</span>
  }
&nbsp;
<span class="cstat-no" title="statement not covered" >  if (domHelpers.IGNORE_TEXT_ELEMENT.hasOwnProperty(node.tagname)) {</span>
<span class="cstat-no" title="statement not covered" >    return true;</span>
  }
&nbsp;
